...
var namePerson = "Alejandro";
var saludo = "Hola " + namePerson; // arreglos 

var people = [];
people = ["Alejandro", "Nicole", "Isabel"]; // people.push(1100); ERROR
...
console.log("Mi color favorito es " + colorFav); // any
